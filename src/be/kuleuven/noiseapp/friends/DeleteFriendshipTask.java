...
public class DeleteFriendshipTask extends AsyncTask<Long, Void, Long> {
	
	private Activity rActivity;
	private SharedPreferences sp;
	private static final String url_delete_friendship = Constants.BASE_URL_MYSQL + "delete_friendship.php";
	private JSONParser jsonParser = new JSONParser();

	public DeleteFriendshipTask(Activity rActivity){
	...
	protected Long doInBackground(Long... friendID) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(url_delete_friendship, "POST", params);
        
        Log.d("DeleteFriendshipResponse", json.toString());
