...
public class RiversideRecordTask extends RecordingTask {
	RiversideRecordActivity rActivity;
	
	public RiversideRecordTask(View v, RiversideRecordActivity rActivity) {
		super(v, rActivity);
